...
void Task(){
     ...
     cout << "| * Task10_3 - Викликає функцію та розраховує значення calculation              | " << endl;
     cout << "|   переводе у двійкову систему та записує у файл Task10_3.txt                  | " << endl;
...
void Task10_3()
{
    ...
    cout << "У двiйковiй системi  B = " << dec2bin(b) << endl;
